...
public class DBStepDefs {
    ...
    @Then("verify that book is shown in the page And verify logged student has same book in database")
    public void verifyThatBookIsShownInThePageAndVerifyLoggedStudentHasSameBookInDatabase() {
